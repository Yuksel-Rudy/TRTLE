...
class Farm:
    ...
    def create_layout(self, layout_type, layout_properties, mooring_orientation, trtle):
        # turbine selection
        ...
        if layout_type == "standard":
            self.standard_layout(layout_properties["farm properties"], mooring_orientation, trtle)
        elif layout_type == "honeymooring":
            self.honeymooring_layout(layout_properties["farm properties"], mooring_orientation, trtle)
        else:
    ...
    def standard_layout(self, farm_properties, mooring_orientation, trtle):
    ...
    def honeymooring_layout(self, farm_properties, mooring_orientation, trtle):
